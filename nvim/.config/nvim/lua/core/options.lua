...
-- < https://stackoverflow.com/a/76845374 >
...
o.wildignore = o.wildignore
  .. "*.o,*.out,*.obj,.git,*.rbc,*.rbo,*.class,.svn,*.gem,*.pyc,*.zip,*.tar.gz,*.tar.bz2,*.rar,*.tar.xz,*.jpg,*.jpeg,*.png,*.gif,*.pdf,*/vendor/gems/*,*/vendor/cache/*,*/.bundle/*,*/.sass-cache/**,**/tmp/**,*.DS_Store,**/node_modules/**,**/bower_modules/**,*.swp,*~,._*"
