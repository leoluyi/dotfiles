return {
  {
    ...
    keys = {
      ...
      },
      {
        ...
        desc = "Search Buffer Dir",
      },
      -- Picker: buffers (vertical, compact)
      {
        "<leader>bb",
        function()
          Snacks.picker.buffers({ layout = { preset = "vertical", layout = { width = 0.6, height = 0.55 } } })
        end,
        desc = "Find Buffers",
      },
      -- Picker: grep (vertical, tall — use "-- -g *.lua" for glob filters)
      {
        "<leader>sg",
        function()
          Snacks.picker.grep({ layout = { preset = "vertical", layout = { height = 0.95 } } })
        end,
        desc = "Grep",
      },
      {
        "<leader>sG",
        function()
          Snacks.picker.grep({ layout = { preset = "vertical", layout = { height = 0.95 } }, hidden = true })
        end,
        desc = "Grep (hidden)",
      },
      {
        "<leader>sw",
        function()
          Snacks.picker.grep_word({ layout = { preset = "vertical", layout = { height = 0.95 } } })
        end,
        desc = "Search Word",
        mode = { "n", "x" },
      },
