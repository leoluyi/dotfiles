...
Shell functions via [`llm` CLI](https://llm.datasette.io/) (`llm-cmd`, `llm-explain`, `llm-fix`, `Alt+a`) and [`fabric-ai`](https://github.com/danielmiessler/fabric) (`??` general query). Custom fabric patterns are tracked in this repo and symlinked via Stow.
