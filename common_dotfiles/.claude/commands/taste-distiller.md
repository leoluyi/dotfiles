---
description: Mine your rejections of AI output and distill them into a reusable Taste Profile rubric (Markdown + JSON)
argument-hint: [domain you use AI for, or blank to be asked]
effort: high
---
...
<scope>
If $ARGUMENTS is non-empty, treat it as the user's answer to Stage A (the domain) and start from Stage B. If it is empty, start at Stage A.
</scope>
