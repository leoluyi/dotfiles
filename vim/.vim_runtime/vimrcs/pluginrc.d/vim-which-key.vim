...
let g:which_key_map['a']  = [':e <C-r>=getcwd()<CR>/',   'new-file-in-directory-of-open-file']
let g:which_key_map['A']  = [':e %:h/'          ,   'new-file-in-working-directory']
...
" let g:which_key_map2["'"] = [ 'viw<esc>`>a"<esc>`<i"<esc>', 'single-quote-word' ]
" let g:which_key_map2['D'] = [ 'viw<esc>`>a"<esc>`<i"<esc>', 'delete' ]

let g:which_key_map[','] = { 'name': 'which_key_ignore' }

let g:which_key_map['t'] = {
      \ 'name' : '+tabs'  ,
      \ 'h': ['<C-w>t<C-w>H', 'tab-vertical-to-horizontal'],
      \ 'k': ['<C-w>t<C-w>K', 'tab-horizontal-to-vertical'],
      \ 'l': [':execute "tabn ".g:lasttab<CR>', 'toggle-last-tabs'],
      \ 'e': [':tabedit <C-r>=expand("%:p:h")<cr>/', 'open-new-tab-with-current-path'],
      \ }
